...
class AddUserCommand extends Command
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->addOption('isAdmin', '', InputArgument::OPTIONAL, 'If the user is created administrator', 0)
        ;
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $stopwatch->start('start-user-command');
        ...
        $event = $stopwatch->stop('start-user-command');
