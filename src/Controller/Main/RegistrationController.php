...
class RegistrationController extends AbstractController
{
    ...
    public function registration(Request $request, UserPasswordHasherInterface $userPasswordHasherInterface): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->emailVerifier->sendEmailConfirmation('main_verify_email', $user,
                (new TemplatedEmail())
                    ->from(new Address('robot@symfony-shop.com', 'Robot'))
                    ->to($user->getEmail())
            ...
            $this->addFlash('warning', 'Проверьте вашу почту');
